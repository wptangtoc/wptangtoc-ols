...
* **Khắc phục lỗi vòng lặp thực thi (exec loop):** Xử lý triệt để lỗi tương thích khi gọi lệnh qua `exec`, loại bỏ hoàn toàn nguy cơ rơi vào vòng lặp vô hạn gây treo tiến trình và quá tải tài nguyên CPU/RAM, đảm bảo máy chủ luôn duy trì trạng thái vận hành ổn định và thông suốt.
