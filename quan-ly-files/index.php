...
$CONFIG = '{"lang":"vi","error_reporting":false,"show_hidden":true,"hide_Cols":false,"calc_folder":false,"theme":"light"}';
...
//Application Title
define('APP_TITLE', 'Quản lý File - WPTangToc OLS');
...
$username_web = file_get_contents('.user-giatuan.json');
$password_web = file_get_contents('.password-giatuan.json');

if (! $username_web || !$password_web){
echo 'bạn chưa thiết lập tài khoản quản lý file';
exit;
}
...
$default_timezone = 'Asia/Ho_Chi_Minh'; // gio viet nam chuyen ve
...
$favicon_path = 'https://wptangtoc.com/wp-content/uploads/2021/05/favicon.png';

// Files and folders to excluded from listing
// e.g. array('myfile.html', 'personal-folder', '*.php', ...)
$exclude_items = array('quan-ly-files','phpmyadmin');
                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                       <div class="brand">
<img src='data:image/png;base64,'/>
                                        </div>
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            Phần mềm phát tiển bởi CCP Programmers và WPTangToc OLS (Gia Tuấn) &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
...
if (isset($_GET['upload']) && !FM_READONLY) {
    ...
    <div class="path">
        ...
        <div class="card mb-2 fm-upload-wrapper <?php echo fm_get_theme(); ?>">
            ...
            <div class="card-body">
				<p class="card-text">
<p>Hiện tại file dung lượng được uploads tối đa cho phép là <strong><?php echo ini_get("upload_max_filesize"); ?>B</strong>, nếu như bạn muốn uploads file dung lượng lớn hơn <strong><?php echo ini_get("upload_max_filesize"); ?>B</strong> thì hãy vào menu WPTangToc OLS rồi vào Quản lý PHP rồi vào tính năng cấu hình uploads max php.ini rồi lựa chọn dung lượng phù hợp nhu cầu bạn mong muốn khi uploads xong thì hãy vui lòng quay trở lại thông số cũ là 8MB hoặc thấp hơn để nâng cao bảo mật (<a href="https://www.youtube.com/watch?v=P3I9RreDD9Y">Video hướng dẫn tăng uploads trong WPTangToc OLS)</a></p>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><p>WPTangToc OLS</p></div>
        <?php else: ?>
...
<a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-5" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="fa fa-user-circle"></i> <?php if(isset($_SERVER[HTTP_HOST])) { echo $_SERVER[HTTP_HOST]; } ?></a>
...
body.fm-login-page{ background-color:#f7f9fb;font-size:14px;}
        ...
        .fm-login-page .card{ border-color:transparent;box-shadow:0 4px 8px rgba(0,0,0,.05);border-radius: 20px;}
        .fm-login-page .card-title{ margin-bottom:1.5rem;font-size:22px;font-weight:400;}
