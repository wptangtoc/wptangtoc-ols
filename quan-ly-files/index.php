...
$username_web = file_get_contents('../../passwd/.user-giatuan.json');
$password_web = file_get_contents('../../passwd/.password-giatuan.json');
...
<a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-5" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="fa fa-user-circle"></i> <?php if(isset($http_host)) { echo $http_host; } ?></a>
