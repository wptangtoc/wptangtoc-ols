...
Yêu cầu hệ điều hành (AlmaLinux 8\9 | Rocky linux 8\9| Ubuntu 22.04) để có thể sử dụng được phần mềm, bạn paste đoạn mã này vào terminal của bạn rồi phần mềm sẽ tự động thiết lập.
